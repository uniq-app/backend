...
public class UserService {
	...
	public Message resendActivationCode(EmailDto emailDto) {
		...
		if (userOptional.isPresent()) {
			...
			EmailService.sendEmail(user.getEmail(), "Activation mail", "Activate your UNIQ account using this code: " + newCode.getValue());
	...
	public Message sendCodeToChangeEmail(User user) {
		...
		EmailService.sendEmail(user.getEmail(), "Change mail code", "Change your email in UNIQ account using this code: " + code.getValue());
	...
	public Message sendCodeToResetPassword(EmailDto email) {
		...
		if (userOptional.isPresent()) {
			User user = userOptional.get();
			Code code = codeService.generateCode(user.getUserId());
			EmailService.sendEmail(email.getEmail(), "Activation mail", "Activate your UNIQ account using this code: " + code.getValue());
